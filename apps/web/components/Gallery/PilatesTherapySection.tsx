      ...
      <div className="mx-auto w-full max-w-[90vw] px-4">
        ...
        <div className="grid grid-cols-2 items-start gap-3 lg:grid-cols-12 lg:gap-4">
          <GalleryIntrinsicTile
            tile={a}
            className="col-span-1 max-lg:order-1 max-lg:rounded-3xl max-lg:rounded-tl-[48px] max-lg:rounded-tr-[18px] max-lg:rounded-bl-[18px] max-lg:rounded-br-[48px] lg:col-span-3 lg:rounded-none lg:rounded-tl-[72px] lg:rounded-br-[72px] lg:rounded-tr-[24px] lg:rounded-bl-[24px]"
          ...
          <GalleryIntrinsicTile
            tile={b}
            className="col-span-1 max-lg:order-2 max-lg:rounded-3xl max-lg:rounded-tl-[48px] max-lg:rounded-tr-[18px] max-lg:rounded-bl-[18px] max-lg:rounded-br-[48px] lg:col-span-3 lg:rounded-none lg:rounded-tr-[72px] lg:rounded-bl-[72px] lg:rounded-tl-[24px] lg:rounded-br-[24px]"
            sizes="(min-width: 1024px) 50vw, 45vw"
            fadeDelayMs={300}
          />
        </div>
