...
export const metadata = pageMetadata({
  ...
  description: "Structured society exercise sessions bringing fitness and physiotherapy guidance to residential communities—helping people stay active, connected, and healthy.",
  path: "/society-exercise",
  ogImage: "/society-hero.png",
  ogImageAlt: "Society Exercise Sessions",
});
