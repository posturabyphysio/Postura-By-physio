          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`rounded-full border border-primary bg-transparent px-4 py-2 text-sm font-medium text-primary transition-colors md:px-5 md:py-2.5 ${
                  isActive ? "font-semibold" : "font-normal hover:bg-primary/[0.06]"
                }`}
              >
                {cat.label}
              </button>
